...
namespace Hyhrobot.WebReptile.Migrations
{
    public partial class Initial_Migrations : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LoginAttempts_TenancyName_NameOrEmail_Result",
                table: "AbpUserLoginAttempts",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AbpLanguageTexts_TenantId_Source_Language_Key",
                table: "AbpLanguageTexts",
                columns: new[] { "TenantId", "Source", "LanguageName", "Key" });

            migrationBuilder.CreateIndex(
                name: "IX_Subscriptions_NoteName_EntityName_EntityId_UserId",
                table: "AbpNotificationSubscriptions",
                columns: new[] { "NotificationName", "EntityTypeName", "EntityId", "UserId" });

            migrationBuilder.CreateIndex(
                name: "IX_Subscriptions_TenantId_NoteName_EntityName_EntityId_UserId",
                table: "AbpNotificationSubscriptions",
